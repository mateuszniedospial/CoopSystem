...
public class ProjectResource {
    ...
    @GetMapping("/projects/juser/{id}")
    @Timed
    public List<Project> getAllProjectsOfJUser(@PathVariable Long id) {
        log.debug("REST request to get all Projects of specific JUser");
        return projectRepository.findAllJUserProjects(id);
    }
    ...
    @GetMapping("/projects/byJGroupId")
    @Timed
    public List<Project> getProjectByJGroupId(@RequestParam(value = "query", required = false)  Long jGroupId) {
        log.debug("REST request to get Project : {}", jGroupId);
        List<Project> project = projectRepository.findProjectByJGroupId(jGroupId);
        return project;
    }
