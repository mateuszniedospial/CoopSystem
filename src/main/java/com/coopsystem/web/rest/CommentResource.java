...
import com.coopsystem.repository.CommentRepository;
...
public class CommentResource {
    ...
    public CommentResource(CommentRepository commentRepository, TaskHistoryDiffService taskHistoryDiffService) {
    ...
    public ResponseEntity<Comment> createComment(@RequestBody Comment comment) throws URISyntaxException {
        ...
        taskHistoryDiffService.createHistoryForComment(comment);
    ...
    public ResponseEntity<Comment> updateComment(@RequestBody Comment comment) throws URISyntaxException {
        ...
        taskHistoryDiffService.updateTaskCommentHistory(oldComment, comment);
        Comment result = commentRepository.save(comment);
    ...
    @GetMapping("/comments")
    @Timed
    public List<Comment> getAllComments(@RequestParam(value = "taskid", required = false)  Long taskId) {
